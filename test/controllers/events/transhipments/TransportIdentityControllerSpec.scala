...
class TransportIdentityControllerSpec extends SpecBase with AppWithDefaultMockFixtures {

  private val formProvider       = new TransportIdentityFormProvider()
  private val form: Form[String] = formProvider()
  private val mode               = NormalMode

  lazy val transportIdentityRoute: String = transhipmentRoutes.TransportIdentityController.onPageLoad(mrn, eventIndex, mode).url
  ...
  "TransportIdentity Controller" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      val view = injector.instanceOf[TransportIdentityView]
