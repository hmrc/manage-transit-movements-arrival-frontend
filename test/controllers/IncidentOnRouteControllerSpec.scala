...
class IncidentOnRouteControllerSpec extends SpecBase with AppWithDefaultMockFixtures {
  ...
  private val formProvider = new IncidentOnRouteFormProvider()
  private val form         = formProvider()

  private lazy val incidentOnRouteRoute = routes.IncidentOnRouteController.onPageLoad(mrn, NormalMode).url
  ...
  "IncidentOnRoute Controller" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      val view = injector.instanceOf[IncidentOnRouteView]
    ...
    "must redirect to the next page when valid data is submitted" in {
      ...
      val request = FakeRequest(POST, incidentOnRouteRoute)
