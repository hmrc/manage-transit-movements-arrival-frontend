...
class CoordinatesControllerSpec extends SpecBase with AppWithDefaultMockFixtures with Generators {
  ...
  private lazy val coordinatesRoute = routes.CoordinatesController.onPageLoad(mrn, mode, index).url
  ...
  "Coordinates Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = emptyUserAnswers.setValue(CoordinatesPage(index), testCoordinates)
