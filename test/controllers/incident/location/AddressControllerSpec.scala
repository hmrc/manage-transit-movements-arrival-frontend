  ...
  "Address Controller" - {
    ...
    "must return OK and the correct view for a GET" - {
      ...
      "when postcode is required" in {
        ...
        contentAsString(result) mustEqual
          view(form(isPostalCodeRequired), mrn, mode, index, isPostalCodeRequired)(request, messages).toString
      }
    ...
    "must populate the view correctly on a GET when the question has previously been answered" - {
      ...
      "when postcode is required" in {
        ...
        val userAnswers = emptyUserAnswers
          .setValue(IncidentCountryPage(index), country)
          .setValue(AddressPage(index), testAddress)
        ...
        contentAsString(result) mustEqual
          view(filledForm, mrn, mode, index, isPostalCodeRequired)(request, messages).toString
      }
    ...
    "must return a Bad Request and errors when invalid data is submitted" - {
      ...
      "when postcode is required" in {
        ...
        contentAsString(result) mustEqual
          view(boundForm, mrn, mode, index, isPostalCodeRequired)(request, messages).toString
      }
