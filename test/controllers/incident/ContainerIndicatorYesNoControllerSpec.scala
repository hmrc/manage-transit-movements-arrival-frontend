...
class ContainerIndicatorYesNoControllerSpec extends SpecBase with AppWithDefaultMockFixtures with MockitoSugar {
  ...
  "ContainerIndicatorYesNo Controller" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      val view = injector.instanceOf[ContainerIndicatorYesNoView]
    ...
    "must redirect to the next page when valid data is submitted" in {
      ...
      val request =
        FakeRequest(POST, containerIndicatorYesNoRoute)
    ...
    "must return a Bad Request and errors when invalid data is submitted" in {
      ...
      val request   = FakeRequest(POST, containerIndicatorYesNoRoute).withFormUrlEncodedBody(("value", ""))
    ...
    "must redirect to Session Expired for a POST if no existing data is found" in {
      ...
      val request = FakeRequest(POST, containerIndicatorYesNoRoute)
        .withFormUrlEncodedBody(("value", "true"))
