...
import views.html.incident.equipment.ContainerIdentificationNumberYesNoView
...
class ContainerIdentificationNumberYesNoControllerSpec extends SpecBase with AppWithDefaultMockFixtures with MockitoSugar {
  ...
  "ContainerIdentificationNumberYesNo Controller" - {
    ...
    "must redirect to the next page when valid data is submitted" in {
      ...
      val request =
        FakeRequest(POST, containerIdentificationNumberYesNoRoute)
    ...
    "must return a Bad Request and errors when invalid data is submitted" in {
      ...
      val request   = FakeRequest(POST, containerIdentificationNumberYesNoRoute).withFormUrlEncodedBody(("value", ""))
    ...
    "must redirect to Session Expired for a POST if no existing data is found" in {
      ...
      val request = FakeRequest(POST, containerIdentificationNumberYesNoRoute)
        .withFormUrlEncodedBody(("value", "true"))
