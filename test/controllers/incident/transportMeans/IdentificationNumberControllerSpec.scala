...
class IdentificationNumberControllerSpec extends SpecBase with AppWithDefaultMockFixtures with Generators {
  ...
  private val form                           = formProvider("incident.transportMeans.identificationNumber", identification.arg)
  ...
  "IdentificationNumber Controller" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      contentAsString(result) mustEqual
        view(form, mrn, mode, incidentIndex, identification)(request, messages).toString
    }
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = emptyUserAnswers
        .setValue(IdentificationPage(incidentIndex), identification)
        .setValue(IdentificationNumberPage(incidentIndex), validAnswer)
      ...
      contentAsString(result) mustEqual
        view(filledForm, mrn, mode, incidentIndex, identification)(request, messages).toString
    }
