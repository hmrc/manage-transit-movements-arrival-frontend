...
class ArrivalDateViewSpec extends DateInputViewBehaviours {
  ...
  override def applyView(form: Form[LocalDate]): HtmlFormat.Appendable =
    injector.instanceOf[ArrivalDateView].apply(form, mrn, NormalMode)(fakeRequest, messages)

  override val prefix: String = "identification.arrivalDate"
