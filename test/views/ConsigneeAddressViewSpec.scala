...
class ConsigneeAddressViewSpec extends AddressViewBehaviours {
  ...
  override def form: Form[Address] = new ConsigneeAddressFormProvider()("Hello")

  override def applyView(form: Form[Address]): HtmlFormat.Appendable =
    injector.instanceOf[ConsigneeAddressView].apply(form, mrn, NormalMode)(fakeRequest, messages)
