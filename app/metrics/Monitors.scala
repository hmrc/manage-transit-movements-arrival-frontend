...
object Monitors {
  ...
  val getCustomsOfficesForCountryMonitor: DefaultRequestMonitor[Seq[CustomsOffice]] =
    DefaultRequestMonitor[Seq[CustomsOffice]]("get-customs-offices-for-the-country")
