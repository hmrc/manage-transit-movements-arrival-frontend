...
sealed trait InternationalAddressLine {
  val field: String
  def arg(implicit messages: Messages): String = messages(s"address.$field")
}

object InternationalAddressLine {

  case object AddressLine1 extends InternationalAddressLine {
    override val field: String = "addressLine1"
    val length: Int            = 35
    val regex: Regex           = stringFieldRegex
  }

  case object AddressLine2 extends InternationalAddressLine {
    override val field: String = "addressLine2"
    val length: Int            = 35
    val regex: Regex           = stringFieldRegex
  }

  case object PostalCode extends InternationalAddressLine {
    override val field: String = "postalCode"
    val length: Int            = 9
    val regex: Regex           = postalCodeRegex
  }

  case object Country extends InternationalAddressLine {
