...
object DynamicRadioable {

  implicit class DynamicRadioables[T](radioables: Seq[DynamicRadioable[T]]) {

    def toRadioItems(formKey: String, checkedValue: Option[DynamicRadioable[T]])(implicit messages: Messages): Seq[RadioItem] =
