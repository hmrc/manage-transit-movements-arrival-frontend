...
import models.{Coordinates, Index, Mode, UserAnswers}
import pages.QuestionPage
import pages.sections.incident
import play.api.libs.json.JsPath
import play.api.mvc.Call

case class CoordinatesPage(index: Index) extends QuestionPage[Coordinates] {
  ...
  override def route(userAnswers: UserAnswers, mode: Mode): Option[Call] =
    Some(routes.CoordinatesController.onPageLoad(userAnswers.mrn, mode, index))
}
