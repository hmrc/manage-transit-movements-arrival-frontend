...
case class TransportNationalityPage(index: Index) extends QuestionPage[Nationality] {
  ...
  override def route(userAnswers: UserAnswers, mode: Mode): Option[Call] =
    Some(routes.TransportNationalityController.onPageLoad(userAnswers.mrn, mode, index))
}
