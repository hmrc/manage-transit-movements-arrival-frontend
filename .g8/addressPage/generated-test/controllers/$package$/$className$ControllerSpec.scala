  ...
  "$className$ Controller" - {
    ...
    "must return OK and the correct view for a GET" - {
      ...
      "when postcode is required" in {
        ...
        contentAsString(result) mustEqual
          view(form(isPostalCodeRequired), mrn, mode, addressHolderName, isPostalCodeRequired)(request, messages).toString
      }
    ...
    "must populate the view correctly on a GET when the question has previously been answered" - {
      ...
      "when postcode is required" in {
        ...
        contentAsString(result) mustEqual
          view(filledForm, mrn, mode, addressHolderName, isPostalCodeRequired)(request, messages).toString
      }
    ...
    "must return a Bad Request and errors when invalid data is submitted" - {
      ...
      "when postcode is required" in {
        ...
        contentAsString(result) mustEqual
          view(boundForm, mrn, mode, addressHolderName, isPostalCodeRequired)(request, messages).toString
      }
