...
lazy val root = (project in file("."))
  ...
  .settings(
    ...
    TwirlKeys.templateImports ++= Seq(
      ...
      "viewModels.InputSize",
      "viewModels.LabelSize",
      "viewModels.LabelSize._",
      "viewModels.LegendSize",
      "viewModels.LegendSize._",
      "templates._"
    ),
    ...
    Concat.groups := Seq(
      "javascripts/application.js" -> group(Seq("javascripts/ctc.js", "javascripts/accessible-autocomplete.js"))
    ),
